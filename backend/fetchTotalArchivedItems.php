...
try {
    ...
    $whereClause = "WHERE p.status = 'ARCHIVED' AND u.is_banned = 0";
    ...
    $query = "SELECT COUNT(p.item_id) as total_archived_items FROM posted_items p JOIN users u ON p.user_id = u.user_id $whereClause";
