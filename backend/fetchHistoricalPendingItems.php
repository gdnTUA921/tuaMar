...
try {
    ...
    $whereClause = "WHERE status = 'IN REVIEW'";
    ...
    $query = "SELECT COUNT(item_id) as total_pending_items FROM posted_items $whereClause";
    ...
    if ($result) {
        ...
        throw new Exception("Failed to fetch pending items count");
    }
} catch (Exception $e) {
