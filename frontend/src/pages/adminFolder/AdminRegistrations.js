          ...
          {registrations.map((reg) => (
            <div key={reg.registration_id} className="registration-card">
              ...
              <div className="reg-info">
                ...
                <p><strong>Type of User:</strong> {reg.user_type}</p>
              ...
              <div className="school-id-preview">
                <h4>School ID:</h4>
                <img
                  src={reg.school_id_image}
                  alt="School ID"
                  onClick={() => {
                    setShowEnlargeImg(true);
                    setEnlargedImg(reg.school_id_image);
                  }}
        ...
        <div className="image-preview-overlay" onClick={closeViewModalPopup}>
          <div className="image-preview-container" onClick={(e) => e.stopPropagation()}>
            <div className="image-preview-header">
              <h3>School ID Preview</h3>
              <button className="close-preview-btn" onClick={closeViewModalPopup}>
                ×
              </button>
            </div>
            <div className="image-preview-content">
              <img src={enlargedImg} alt="School ID Preview" className="popup-preview-image" />
            </div>
          </div>
        </div>
      )}
